...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/power"
...
theme.volume.bar:buttons(my_table.join (
          awful.button({}, 1, function()
            ...
            --chanced alsamixer for pulsemixer
          end),
...
local volumebg = wibox.container.background(theme.volume.bar, "#FEFEFE", gears.shape.rectangle)
...
theme.weather = lain.widget.weather({
    city_id = 2745912, -- placeholder (Utrecht, id found on openweathermap.org)
